define({
  root: ({
    ...
    user: {
      ...
      //applyEditsFailedMessage: "Sorry your entry cannot be submitted. Enter a number or leave blank the Contracted Speed or Speed Delivered text boxes. Please try again.",
